...
<span style="color: teal;">
In which distribution(s) do you see complete spatial randomness (CSR)? Include a 3 by 2 plot of the point locations and L-function with envelope (See example of Canvas) (10 pts).
</span>
